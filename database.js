...
=========================================================
SIARENA DATABASE
Sistem Integrasi, Analisis Residu serta Nilai Alternatif
=========================================================
*/

const SIARENA_DATABASE = {
...
function getAlternatives() {
    ...
    return SIARENA_DATABASE.alternatives;
...
function getAlternativeById(id) {
    ...
    return SIARENA_DATABASE.alternatives.find(
        alternative =>
            alternative.id === id
    );
